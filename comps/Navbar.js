                ...
                <nav className="navbar navbar-expand-md d-flex flex-column flex-lg-row align-items-center p-3 px-md-4">
                    ...
                    <div className="collapse navbar-collapse justify-content-end" id="navbarNav">
                       <div className="navbar-nav my-2 my-md-0 me-md-3" >
                            <Link legacyBehavior href='/aboutme'><a className="p-2 nav-link">About Me</a></Link>
                            <Link legacyBehavior href='/portfolio'><a className="p-2 nav-link">Portfolio</a></Link>
                            <Link legacyBehavior href='/requestservices'><a className="p-2 nav-link">Request Services</a></Link>
                            <Link legacyBehavior href='/contactme'><a className="p-2 nav-link">Contact Me</a></Link>
                        </div> 
                    </div>
