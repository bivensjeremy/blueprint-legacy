            ...
            <main className="container py-5">
                ...
                <div className="d-flex justify-content-center pb-5">
                    <div className="text-center me-2">
                        <Link legacyBehavior href="/requestservices">
                            <button className="btn btn-primary text-white fw-bold text-uppercase btn-lg">Package Information</button>
                        </Link>
                    </div>

                    <div className="text-center ms-2">
                        <Link legacyBehavior href="https://www.honeybook.com/widget/bivens_blueprint_llc_191523/cf_id/612fa0a4ceb19b0e829a228d">
